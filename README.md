...
SpoutNBT is licensed under [GNU LESSER GENERAL PUBLIC LICENSE Version 3][License], but with a provision that files are released under the MIT license 180 days after they are published. Please see the `LICENSE.txt` file for details.

Who is SpoutDev?
----------------
SpoutDev is the team behind Spout, SpoutAPI, SpoutNBT, Spoutcraft, SpoutcraftAPI, Spoutcraft Launcher, SpoutPlugin, SpoutPluginAPI, Vanilla, and BukkitBridge.  
...
Compiling
---------
SpoutNBT uses Maven to handle its dependencies.
...
[Donate]: https://www.paypal.com/cgi-bin/webscr?hosted_button_id=QNJH72R72TZ64&item_name=SpoutNBT+donation+%28from+github.com%29&cmd=_s-xclick
